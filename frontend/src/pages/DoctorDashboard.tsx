        ...
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-md bg-white h-full shadow-2xl flex flex-col animate-[slide-left_0.3s_ease-out]">
            ...
            <div className="p-8 border-b border-navy-100 flex items-center justify-between bg-navy-50">
              ...
              <button onClick={() => setSelectedPatient(null)} className="p-2 hover:bg-navy-100 rounded-xl text-navy-400 transition-colors">
                <X size={24} />
              </button>
            </div>
            ...
            <div className="p-6 border-t border-navy-100 bg-white space-y-3">
              <button className="w-full py-3.5 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-xl transition-all shadow-sm flex items-center justify-center gap-2">
                <Activity size={18} /> Start Consultation
              </button>
              <button className="w-full py-3.5 border-2 border-navy-100 text-navy-600 font-bold rounded-xl hover:bg-navy-50 hover:border-navy-200 transition-all">
                View Full Chart
              </button>
            </div>
          </div>
